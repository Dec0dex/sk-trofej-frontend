<template>
  <div style="background: #2F3242; width: 100vh; height: 100vh" >
    ...
    <div class="message-box">
      ...
      <div class="buttons-con">
        <div class="action-link-wrap">
          <a onclick="history.back(-1)" class="link-button link-back-button">Natrag</a>
          <a href="" class="link-button">Idi na početnu</a>
        </div>
      </div>
    </div>
  </div>
